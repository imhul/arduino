 ...
 * Function description：Write a byte of data to a MFRC522 of a register
 * input parameter：addr--Register address；val--Value to be written
 * Return value: None
 */
 ...
 * input parameter：reg--Register address ;mask--Set value
 * Return value: None
 */
 ...
 *input parameter：reg--Register address;mask--Clear bit value
 * Return value: None
 */
 ...
 * Function description：Open the antenna, every time you start or shut down at least 1ms                        should launch the interval between the natural barrier
 ...
 * Function Description: turn off the antenna, every time you start or shut down at least 1ms should launch the interval between the natural barrier
 * Input parameters: None
 * Return value: None
 */
 ...
 * Function description：initialization RC522
 * Input parameters: None
 * Return value: None
 ...
 *Function description：Find cards, read card type
 * input parameter：reqMode--Card searching method，
 ...
 * Return value：Successful return MI_OK
 */
 ...
 * Function description：RC522 & ISO14443 Card communication
 * input parameter：command--MF522Command word，
 *			 sendData--Data sent through RC522 to the card, 
 *			 sendLen--Data length of transmission		 
...
Write_MFRC522(CommIEnReg, irqEn|0x80);	//Allow interrupt request
	...
	i = 2000;	//iAccording to the clock frequency adjustment，Operation M1 card maximum waiting time 25ms	???
    do 
    {
		//CommIrqReg[7..0]
 ...
 * Function description：The card serial number of the selected card is read against the conflict detection.
 *input parameter：serNum--Returns the serial number of the 4 byte, and the fifth byte is the check byte
 ...
 * Function Description: using MF522 calculation CRC
 * input parameter：pIndata--Data to read CRC，len--Data length，pOutData--Calculated CRC results
 * Return value: None
 */
 ...
 * Function Description: card selection, memory card memory capacity
 *Input parameters: serNum-- incoming card serial number
 * Return value: the successful return card capacity
 */
 ...
 * Input parameters: blockAddr-- block address; block data read out of recvData--
 * Return value: return to MI_OK */
